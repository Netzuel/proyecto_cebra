            ...
            if(sum(colnames(prueba) == colnames(datos$datos)) == ncol(prueba)){
              if(nrow(prueba) >= 1){
                ...
                for(i in seq_len(nrow(prueba))){
                  if(is.character(prueba[i,][[1]]) & is.character(prueba[i,][[2]]) & is.character(prueba[i,][[3]]) & is.numeric(prueba[i,][[4]]) & is.numeric(prueba[i,][[5]]) & is.numeric(prueba[i,][[6]]) & is.numeric(prueba[i,][[7]]) & is.numeric(prueba[i,][[8]])){
                    verifier <- verifier + 1
                  }
                }
